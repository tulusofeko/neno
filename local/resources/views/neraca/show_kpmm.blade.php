    ...
    <tr>
        ...
        <td></td>
        <td></td>
        <td align="right">{{ number_format(($total_modal_1/$total1_total_atmr)*100, 2, ",", ".") }}%</td>
        <td></td>
        <td></td>
        <td align="right">{{ number_format(($total_modal_2/$total2_total_atmr)*100, 2, ",", ".") }}%</td>
        <td></td>
        <td></td>
        <td align="right">{{ number_format(($total_modal_3/$total3_total_atmr)*100, 2, ",", ".") }}%</td>
    </tr>
