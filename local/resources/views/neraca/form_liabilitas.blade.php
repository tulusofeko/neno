...
<div class="row" align="center" style="margin-top: 10px;">
	...
	<div class="col-md-2">
		{!! Form::number("dana_utama",null,['class'=>'form-control','id'=>'dana_utama','autocomplete' => 'off']) !!}
	</div>
	<div class="col-md-1">
...
<div class="row" align="center" style="margin-top: 10px;">
	...
	<div class="col-md-2">
		{!! Form::number("liabilitas_bi_utama",null,['class'=>'form-control','id'=>'liabilitas_bi_utama','autocomplete' => 'off']) !!}
	</div>
	<div class="col-md-1">
...
<div class="row" align="center" style="margin-top: 10px;">
	...
	<div class="col-md-2">
		{!! Form::number("liabilitas_lain_utama",null,['class'=>'form-control','id'=>'liabilitas_lain_utama','autocomplete' => 'off']) !!}
	</div>
	<div class="col-md-1">
...
<div class="row" align="center" style="margin-top: 10px;">
	...
	<div class="col-md-2">
		{!! Form::number("suberl_utama",null,['class'=>'form-control','id'=>'suberl_utama','autocomplete' => 'off']) !!}
	</div>
	<div class="col-md-1">
		{!! Form::number("suberl_d1",null,['class'=>'form-control','id'=>'suberl_d1','autocomplete' => 'off']) !!}
	</div>
	<div class="col-md-1">
		{!! Form::number("suberl_k1",null,['class'=>'form-control','id'=>'suberl_k1','autocomplete' => 'off','style' => 'background-color: #fff5cc;']) !!}
	</div>
	<div class="col-md-1">
		{!! Form::number("suberl_d2",null,['class'=>'form-control','id'=>'suberl_d2','autocomplete' => 'off']) !!}
	</div>
	<div class="col-md-1">
		{!! Form::number("suberl_k2",null,['class'=>'form-control','id'=>'suberl_k2','autocomplete' => 'off','style' => 'background-color: #fff5cc;']) !!}
	</div>
	<div class="col-md-1">
		{!! Form::number("suberl_d3",null,['class'=>'form-control','id'=>'suberl_d3','autocomplete' => 'off']) !!}
	</div>
	<div class="col-md-1">
...
<div class="row" align="center" style="margin-top: 10px;">
	...
	<div class="col-md-2">
		{!! Form::number("liabilitas_diterima_utama",null,['class'=>'form-control','id'=>'liabilitas_diterima_utama','autocomplete' => 'off']) !!}
	</div>
	<div class="col-md-1">
...
<div class="row" align="center" style="margin-top: 10px;">
	...
	<div class="col-md-2">
		{!! Form::number("lainl_utama",null,['class'=>'form-control','id'=>'lainl_utama','autocomplete' => 'off']) !!}
	</div>
	<div class="col-md-1">
		{!! Form::number("lainl_d1",null,['class'=>'form-control','id'=>'lainl_d1','autocomplete' => 'off','style' => 'background-color: #fff5cc;']) !!}
	</div>
	<div class="col-md-1">
		{!! Form::number("lainl_k1",null,['class'=>'form-control','id'=>'lainl_k1','autocomplete' => 'off']) !!}
	</div>
	<div class="col-md-1">
